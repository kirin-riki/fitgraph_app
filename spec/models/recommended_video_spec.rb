...
RSpec.describe RecommendedVideo, type: :model do
  describe 'バリデーション' do
    ...
    it 'video_idがcondition_keyスコープで一意であること', skip: '一時的にskip' do
  ...
  describe '独自メソッド' do
    describe '.condition_key' do
      it 'genderとintensityからkeyを返す', skip: '一時的にskip' do
  ...
  describe 'スコープ' do
    ...
    describe '.recent' do
      it '指定月数以内の動画のみ返す', skip: '一時的にskip' do
    ...
    describe '.for_conditions' do
      it 'genderとintensityに合致する動画のみ返す', skip: '一時的にskip' do
